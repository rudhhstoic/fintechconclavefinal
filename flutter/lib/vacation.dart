...
class _VacationPageState extends State<VacationPage> {
  ...
  Future<void> fetchSavedVacations() async {
    final response = await http.get(
      Uri.parse('http://10.209.192.42:5000/get_vacations/${widget.serialId}'),
    );
  ...
  Future<void> getRecommendations() async {
    final response = await http.post(
      Uri.parse('http://10.209.192.42:5000/recommend_vacation'),
  ...
  Future<void> addVacation(Map vacation) async {
    final response = await http.post(
      Uri.parse('http://10.209.192.42:5000/add_vacation'),
      headers: {'Content-Type': 'application/json'},
