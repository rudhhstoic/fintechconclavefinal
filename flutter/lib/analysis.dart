  ...
  Future<void> fetchAnalysisData() async {
    ...
    switch (selectedAnalysis) {
      case 'Income Category Analysis':
        url =
            'http://10.209.192.42:5000/income_category_analysis/${widget.serialId}';
        break;
      case 'Expense Category Analysis':
        url =
            'http://10.209.192.42:5000/expense_category_analysis/${widget.serialId}';
        break;
      case 'Income vs Expense Analysis':
        url =
            'http://10.209.192.42:5000/income_vs_expense_analysis/${widget.serialId}';
        break;
      default:
        return;
    }
